...
window.WR_DOCS = [
  {
    ...
    html: [
      '<div class="wrdoc-head">',
        ...
        '<div class="wrdoc-meta"><span><b>대상</b> 7·8·9·13층</span><span><b>확정 삭제</b> 대형조성 11개</span><span><b>작성일</b> 2026-08-25</span></div>',
      '</div>',
      ...
      '<section class="wrdoc-sec"><h2><span class="wrdoc-no">01</span>기존 관리 현황</h2>',
        ...
        '<tr class="has-del"><td>9층</td><td>67</td><td>9<span class="del-mark">−6 삭제</span></td><td>5</td></tr>',
        ...
        '<div class="del-callout"><div class="dc-num">−11<small>개 삭제</small></div><div class="dc-body">리모델링으로 <b>대형조성 플랜트박스 총 11개</b>가 삭제됩니다. 9층 <b>6곳</b>, 13층 <b>5곳(플랜트월 포함)</b> — 현재 확정된 삭제량입니다.</div></div>',
      '</section>',
      ...
      '<section class="wrdoc-sec"><h2><span class="wrdoc-no">03</span>삭제 시나리오별 영향</h2>',
        '<div class="wrdoc-scen">',
          '<div class="wrdoc-scard"><p class="tag">시나리오 ①</p><p class="cond">대형조성 11개만 삭제</p><p class="big">16.4<small>%</small></p><p class="sub">공수 −88 · 층 환산 ≈ 0.66층</p></div>',
          '<div class="wrdoc-scard hot"><p class="tag">시나리오 ②</p><p class="cond">대형 11개 + 기본 32개 삭제</p><p class="big">22.3<small>%</small></p><p class="sub">공수 −120 · 층 환산 ≈ 0.89층</p></div>',
        '</div>',
        '<div class="wrdoc-tw"><table class="wrdoc-table"><thead><tr><th>삭제 조건</th><th>공수 감소</th><th>전체 감소율</th><th>층 환산</th></tr></thead>',
        '<tbody><tr><td>① 대형조성 11개만 삭제</td><td class="pos">−88</td><td>16.4%</td><td>≈ 0.66층</td></tr>',
        '<tr><td>② 대형 11개 + 기본 32개 삭제</td><td class="pos">−120</td><td>22.3%</td><td>≈ 0.89층</td></tr>',
        '<tr><td>정확한 1개 층 기준</td><td>≈ 134</td><td>25%</td><td>1층</td></tr></tbody></table></div>',
        '<div class="wrdoc-callout" style="border-left-color:#1b5e3f;"><span class="lbl" style="color:#1b5e3f;">검토 현황 (2026-08-25 기준)</span><p>현재 모빌리티 측에서는 <b>기본 플랜트박스 약 32개</b>의 <b>삭제 여부(삭제·유지)</b>를 검토 중입니다. <b>32개 삭제가 확정되면 시나리오 ②</b>(약 22.3% · 약 0.89개 층), <b>유지되면 시나리오 ①</b>(약 16.4% · 약 0.66개 층)이 적용됩니다.</p></div>',
      '</section>',
      ...
      '<section class="wrdoc-sec"><h2><span class="wrdoc-no">06</span>비용 조정 방안</h2>',
        ...
        '<p class="cs-p">따라서 식재 수량 감소분을 단순 비례하여 관리비에 반영하기보다, <b>실제 감소하는 관리 작업량을 기준으로 조정</b>하는 방향을 제안드립니다.</p>',
        ...
        '<div class="cs-key"><ul><li>임원실 화분 등 일부 식재는 도면상 관리 범위에 별도로 표시되지 않으나, 현장 운영 과정에서 <b>함께 관리</b>하고 있습니다.</li><li>리모델링 이후 소규모 화분이 추가되는 경우에도 <b>별도의 관리비 조정 없이 유연하게 대응</b>하고자 합니다.</li><li>일정 범위 내의 식재 증감은 별도 비용 조정 없이 운영하고, <b>실제 관리 공수에 영향을 주는 규모의 변동</b>이 발생하는 경우 관리비를 조정하는 방식이 양측 모두 효율적이라고 판단합니다.</li><li>리모델링 완료 이후에는 <b>변경된 공간에 맞춰 식물 배치 및 수종 구성</b>도 함께 제안드릴 예정입니다.</li></ul></div>',
        '<p class="cs-bt">관리비 조정 제안</p>',
        '<div class="cs-opts"><div class="cs-opt"><p class="ot">1안 · 9월 적용</p><h4>9월 현행 관리비 유지</h4><p class="amt">3,773,000<small>원 유지</small></p><p class="amtsub">현행 유지</p><p class="d">9월은 리모델링·식재 이동·삭제가 계속 진행되는 과도기이며 4개 층을 모두 관리 중이므로 현행 관리비를 유지합니다. 안정화 이후 <b>10~11월 중 최종 협의</b>합니다.</p></div><div class="cs-opt rec"><p class="ot">2안 · 확정 조정</p><h4>관리 공수 확정 후 조정</h4><p class="amt">3,301,000<small>원</small></p><p class="amtsub">조정액 약 472,000원 (−1시간 상당)</p><p class="d">예상 감소분 <b>1시간 상당 관리비만 반영</b>하여 월 약 3,301,000원으로 조정하는 안입니다.</p></div></div>',
      ...
      '<section class="wrdoc-sec"><h2><span class="wrdoc-no">07</span>최종 요약</h2>',
        '<div class="wrdoc-summary">',
          ...
          '<p>모빌리티 리모델링에 따라 현재 <b>9층·13층 대형조성 플랜트박스 총 11개(플랜트월 포함)</b>가 삭제될 예정입니다.</p>',
          '<p>현장 관리공수 기준(대형 1개 ≈ 기본 8개)으로 환산하면, 확정 삭제분은 기존 관리공수의 <span class="hl">약 16.4%, 약 0.66개 층</span> 수준입니다.</p>',
          '<p>추가 검토 중인 <b>기본 플랜트박스 약 32개</b>까지 삭제될 경우 총 감소율은 <span class="hl">약 22.3%, 약 0.89개 층</span>에 해당합니다.</p>',
